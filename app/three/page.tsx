...
export default async function PartThree() {
  ...
  return (
    <>
      ...
      <Spacer size={32} />
      <p>part three is available now.</p>
      <p>good luck!</p>
      <p><Link href={'https://compsigh.notion.site/riddle-three-683fc44142324fc08eaff17c1f819209?pvs=4'}>open riddle part three</Link> (same tab)</p>
      <Spacer size={32} />
