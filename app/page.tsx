...
export default async function Home() {
  ...
  return (
    <>
      <p>
        welcome to compsigh <code>cascade</code> — <br />
      ...
      <ul>
        ...
        <li>
          <TextStream duration={1.6} text="teams have 30 minutes to complete it" />
        </li>
        <li>
          <TextStream duration={1.4} text="the prize for the winning team is $100" />
        </li>
        <li>
          <TextStream duration={1.8} text="the team with the shortest completion time wins" />
        </li>
      </ul>
      <Spacer size={32} />
      {authed
